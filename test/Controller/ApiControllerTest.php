...
use OnePlace\Calendar\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/calendar/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/calendar/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('calendar-api');
    }
}
