<?php
/**
 * CalendarControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Calendar Module
 *
 * @category Test
 * @package Calendar
...
namespace OnePlaceTest\Calendar\Controller;

use OnePlace\Calendar\Controller\CalendarController;
...
class CalendarControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/calendar', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('calendar');
        $this->assertControllerName(CalendarController::class); // as specified in router's controller name alias
        $this->assertControllerClass('CalendarController');
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/calendar/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('calendar');
        $this->assertControllerName(CalendarController::class); // as specified in router's controller name alias
        $this->assertControllerClass('CalendarController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/calendar/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('calendar');
        $this->assertControllerName(CalendarController::class); // as specified in router's controller name alias
        $this->assertControllerClass('CalendarController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/calendar/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('calendar');
        $this->assertControllerName(CalendarController::class); // as specified in router's controller name alias
        $this->assertControllerClass('CalendarController');
