<?php
/**
 * SearchController.php - Calendar Search Controller
 *
 * Main Controller for Calendar Search
 *
 * @category Controller
 * @package Calendar
...
class SearchController extends CoreSearchController
{
    ...
    /**
     * Dump Calendar data to desired format
     *
     * @return bool
     * @since 1.0.0
     */
    public function indexAction() {
         ...
         * Hooks available:
         *
         * calendar-search-before (before show search form)
         * calendar-search-before-execute (before query)
         * calendar-search-after-execute (after query - before show results)
         */
        return $this->generateSearchView('calendar');
    }
}