<?php
/**
 * ContactTable.php - Contact Table Model
 *
 * Table Entity Model for Contact
...
class CategoryTable
{
    ...
    public function saveCategory(Category $oCat)
    {
        $aData = [
            'label' => $oCat->getLabel(),
        ];
    ...
    {
        $this->tableGateway->delete(['Category_ID' => (int) $id]);
    }
}